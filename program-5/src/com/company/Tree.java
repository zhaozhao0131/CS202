...
public class Tree {
    ...
    public int read_data() throws IOException //read in data file from outside //read data to text file
    {
        ...
        while (sc.hasNextLine()) {
            ...
            System.out.println("TYPE: " + flag + " DECISION: " + data + " COMMON: " + name);
    ...
    public int loadInput() //read in data from user
    {
        ...
        System.out.println("ENTER a new flag [1- Decision] [2- Chance] [3-End] [4-Gift]");
        temp = input.nextInt();
        System.out.println("ENTER a new decision [1-YES] [2-NO]");
        temp1 = input.nextInt();
